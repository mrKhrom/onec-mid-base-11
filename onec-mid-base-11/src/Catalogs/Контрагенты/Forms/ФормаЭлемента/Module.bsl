...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
    ...
    //--{ Khrom 25.07.2023 19:02:55  -- 
	ТЧКонтакныеЛица = Элементы.Добавить("МГ_КонтактныеЛица", Тип("ТаблицаФормы"));
	ТЧКонтакныеЛица.Заголовок = "Контактные лица";
	ТЧКонтакныеЛица.ПутьКДанным = "Объект.МГ_КонтактныеЛица";
	
	ЭлементПоле = Элементы.Добавить("МГ_КонтактныеЛицаКонтактноеЛицо", Тип("ПолеФормы"), ТЧКонтакныеЛица); 
	ЭлементПоле.Вид = ВидПоляФормы.ПолеВвода;
	ЭлементПоле.ПутьКДанным = "Объект.МГ_КонтактныеЛица.КонтактноеЛицо";
	//-- Khrom 25.07.2023 19:03:46  }--
КонецПроцедуры
